...
ffcal, other, xfcal, yfcal = np.genfromtxt(f'force_calibration_{name}_particle1.FDdat', unpack = True)
...
with open(f'results/results_without_force_{name}.txt', 'a') as file:
