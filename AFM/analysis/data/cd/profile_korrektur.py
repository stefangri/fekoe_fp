...
image = mpimg.imread('cd_10_10_100pps_korrektur.jpg')
ax3 = fig.add_subplot(131)
ax3.imshow(image)
ax3.set_yticks([])
ax3.set_xticks([])
ax3.text(0.01 , 0.96, r'(a) CD', horizontalalignment='left', verticalalignment='top', transform = ax3.transAxes, color = 'black')
ax3.set_xticks([0, int(1563/2), 1563])
ax3.set_yticks([0, int(1563/2), 1563])
...
image = mpimg.imread('../dvd/dvd_250_250_100pps_korrektur.jpg')
ax2 = fig.add_subplot(133)
ax2.imshow(image)
ax2.set_yticks([])
ax2.set_xticks([])
ax2.text(0.01 , 0.96, r'(c) DVD', horizontalalignment='left', verticalalignment='top', transform = ax2.transAxes, color = 'black')
ax2.set_xticks([0, int(1563/2), 1563])
ax2.set_yticks([0, int(1563/2), 1563])
...
fig.tight_layout()
fig.savefig('cd_profil_korrektur.pdf', bbox_inches = 'tight', pad_inches = 0)
